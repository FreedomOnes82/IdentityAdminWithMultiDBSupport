...
namespace Framework.Core.Blazor.Admin.SqlServer.Auth.Stores
{
        ...
        IUserLockoutStore<ApplicationUser>, IUserRoleStore<ApplicationUser>, IUserAuthenticationTokenStore<ApplicationUser>, IUserStore<ApplicationUser>
    {
        ...
        public UserStore(IDatabaseConnectionFactory databaseConnectionFactory, IDbConnectionAccessor dbConnectionAccessor, IDataTablePrefixProvider dataTablePrefixProvider) {
            _usersTable = new UsersProvider(databaseConnectionFactory, dbConnectionAccessor, dataTablePrefixProvider);
            _usersRolesTable = new UserRolesProvider(databaseConnectionFactory, dbConnectionAccessor, dataTablePrefixProvider);
            _rolesTable = new RolesProvider(databaseConnectionFactory, dbConnectionAccessor, dataTablePrefixProvider);
            _usersClaimsTable = new UserClaimsProvider(databaseConnectionFactory, dbConnectionAccessor, dataTablePrefixProvider);
            _usersLoginsTable = new UserLoginsProvider(databaseConnectionFactory, dbConnectionAccessor, dataTablePrefixProvider);
            _userTokensTable = new UserTokensProvider(databaseConnectionFactory, dbConnectionAccessor, dataTablePrefixProvider);
        }
