...
namespace Framework.Core.Blazor.Admin.SqlServer.Auth.Stores
{
    public class RoleStore : IQueryableRoleStore<ApplicationRole>, IRoleClaimStore<ApplicationRole>, IRoleStore<ApplicationRole>
    {
        ...
        public RoleStore(IDatabaseConnectionFactory databaseConnectionFactory, IDbConnectionAccessor dbConnectionAccessor, IDataTablePrefixProvider dataTablePrefixProvider) {
            _rolesTable = new RolesProvider(databaseConnectionFactory, dbConnectionAccessor, dataTablePrefixProvider);
            _roleClaimsTable = new RoleClaimsProvider(databaseConnectionFactory, dbConnectionAccessor, dataTablePrefixProvider);
        }
